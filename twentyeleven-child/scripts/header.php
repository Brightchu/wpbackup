...
<!--
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/my_sticky_navbar.js" type="text/javascript"></script>
-->
...
<?php
	...
	/* Always have wp_head() just before the closing </he ad>
	 * tag of your theme, or you will break many plugins, which
	 * generally use this hook to add elements to <hea d> such
...
//make the subnav sticky
    var stickyHeader = jQuery('#access').offset().top+288;
